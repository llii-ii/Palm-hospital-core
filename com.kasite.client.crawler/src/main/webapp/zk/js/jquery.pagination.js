...
jQuery.fn.pagination = function(maxentries, opts){
	...
	return this.each(function() {
		...
		function drawLinks() {
			...
			if(opts.isJump){
				// Generate Jump Input
				panel.append(jQuery("<input type='text' style='text-align:center;height:28px;line-height:28px;margin:0 2px;' id='jump-index' title='请输入正整数' size='1' />"));
				//panel.append(jQuery("<b>/"+numPages()+"  </b>"));
		
				// Generate Jump Handler
				var index = null;
				var jump = jQuery("<button style='height:28px;font-size:12px;line-height:22px;float:right;padding:0 5px;border:1px solid #CCC;background:#EEE;'>"+opts.jump_text+"</button>").bind("click",function(evt){
