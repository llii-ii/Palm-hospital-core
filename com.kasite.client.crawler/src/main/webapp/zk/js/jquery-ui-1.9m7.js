...
$.widget( "ui.tabs", {
	...
	_refresh: function() {
		...
		this.list.addClass( "ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-tabs-header ui-corner-all" );
		this.lis.addClass( "ui-tabs-state-default ui-corner-top" );
