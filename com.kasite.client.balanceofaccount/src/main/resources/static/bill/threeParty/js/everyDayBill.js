...
function loadData() {
    ...
    billTable = $('#billTable').DataTable({
        ...
        "columns": [
            {"data": "billDate", title: "对账日期", width: "8%"},
            {"data": "hisBills", title: "his订单笔数", width: "5%"},
            {"data": "qlcBills", title: "全流程订单笔数", width: "5%"},
            {"data": "channelBills", title: "渠道订单笔数", width: "5%"},
            {"data": "checkNum", title: "已核对笔数", width: "5%"},
            {
                "data": "abnormalNum", title: "总异常笔数", width: "5%", render: function (data, type, row, meta) {
            ...
            {"data": "receivableMoney", title: "应收金额（元）", width: "6%"},
            {"data": "alreadyReceivedMoney", title: "实收金额（元）", width: "6%"},
            {"data": "refundMoney", title: "应退金额（元）", width: "6%"},
            {"data": "alreadyRefundMoney", title: "实退金额（元）", width: "6%"},
            {
                "data": "checkResult", title: "对账结果", width: "6%", render: function (data, type, row, meta) {
                if (data == 1) {
            ...
            {
                "data": "checkState", title: "操作", width: "6%", render: function (data, type, row, meta) {
