  	...
  	$.post('/WbjUI/wbj2/business/web/wtbj_querySubjectById.do', params, function (result) {
  		if(result.Code==10000)
		{
				$('#begin').append(result.BeginIntro);
  				...
  				{
  	  				$('#twosubjecttitle').html(result.SubjectTitle);
  	  				$('#foursubjecttitle').html(result.SubjectTitle);
  				}else
  				{
  					$('#twosubjecttitle').html(result.SubjectTitle.substring(0,15)+'...');
  	  				$('#foursubjecttitle').html(result.SubjectTitle.substring(0,15)+'...');
  				}
 ...
 * 清空特殊字符
 */
function stripscriptName(value) {
  var  val=value;	  
  var containSpecial = RegExp(/[(\ )(\~)(\!)(\@)(\#)(\$)(\￥)(\……)(\*)(\&)(\【)(\】)(\。)(\，)(\%)(\^)(\&)(\*)(\-)(\_)(\+)(\=)(\|)(\\)(\;)(\:)(\')(\")(\,)(\.)(\/)(\?)]+/);    
  var rs = "";    
  for (var i = 0; i < val.length; i++) {    
  	rs = rs + val.substr(i, 1).replace(containSpecial, '');
  } 
  return rs
}
