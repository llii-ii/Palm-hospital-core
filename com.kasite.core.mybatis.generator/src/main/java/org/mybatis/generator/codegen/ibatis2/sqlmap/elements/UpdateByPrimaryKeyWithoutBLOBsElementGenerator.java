...
public class UpdateByPrimaryKeyWithoutBLOBsElementGenerator extends AbstractXmlElementGenerator
{
    ...
    public void addElements(final XmlElement parentElement) {
        ...
        answer.addAttribute(new Attribute("parameterClass", this.introspectedTable.getBaseRecordType()));
        ...
        sb.setLength(0);
        sb.append("set ");
        final Iterator<IntrospectedColumn> iter = this.introspectedTable.getBaseColumns().iterator();
        while (iter.hasNext()) {
