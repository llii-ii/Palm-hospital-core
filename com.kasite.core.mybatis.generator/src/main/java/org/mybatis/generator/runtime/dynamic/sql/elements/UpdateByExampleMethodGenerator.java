...
public class UpdateByExampleMethodGenerator extends AbstractMethodGenerator
{
    ...
    private UpdateByExampleMethodGenerator(final Builder builder) {
        super(builder);
    ...
    public MethodAndImports generateMethodAndImports() {
        if (!this.introspectedTable.getRules().generateUpdateByExampleWithBLOBs() && !this.introspectedTable.getRules().generateUpdateByExampleWithoutBLOBs()) {
            return null;
        }
        ...
        final Method method = new Method("updateByExample");
        ...
        method.addBodyLines(this.fragmentGenerator.getSetEqualLines(this.introspectedTable.getAllColumns(), true));
    ...
    public boolean callPlugins(final Method method, final Interface interfaze) {
        return this.context.getPlugins().clientUpdateByExampleWithBLOBsMethodGenerated(method, interfaze, this.introspectedTable);
    }
