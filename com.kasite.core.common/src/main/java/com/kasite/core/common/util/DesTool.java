...
/**
 * @author linjf 2017年11月14日 18:07:35
 * TODO DES加密工具类
 */
public class DesTool {
	...
	public static byte[] hexStr2ByteArr(String strIn) throws Exception {
		...
		for (int i = 0; i < iLen; i = i +tempNum ) {
	 ...
	 * @throws Exception
	 */
	public DesTool(String strKey) throws Exception {
	 ...
	 * @return 返回加密字符串
	 */
	public static String setEncrypt(String str) throws Exception
	{	
		if(str==null){
			str="";
		}
		DesTool des = new DesTool(key);
		str = des.encrypt(str);
		return str;
	}
