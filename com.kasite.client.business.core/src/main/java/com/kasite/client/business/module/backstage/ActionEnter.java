...
public class ActionEnter {
	...
	public ActionEnter(HttpServletRequest request) {
		this(new StorageManager(), request, null);
	}

	public ActionEnter(HttpServletRequest request, String configPath) {
		this(new StorageManager(), request, configPath);
	}

	public ActionEnter(IStorageManager storage, HttpServletRequest request) {
		this(storage, request, null);
	}

	public ActionEnter(IStorageManager storage, HttpServletRequest request, String configPath) {
		...
		this.configManager = ConfigManager.getInstance(this.contextPath, configPath);
