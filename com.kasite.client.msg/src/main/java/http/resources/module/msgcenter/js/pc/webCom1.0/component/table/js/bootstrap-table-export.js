...
(function ($) {
    ...
    BootstrapTable.prototype.initToolbar = function () {
        ...
        if (this.options.showExport) {
            ...
            if (!$export.length) {
                $export = $([
                    '<div id="export-btn" class="export btn-group">',
                        '<button class="btn' +
                ...
                $menu.find('li').click(function () {
                	...
                	var $table = System.getComponent('#'+$(this).parents('.bootstrap-table').find('[component="table"]').attr('id'));
					$table.tableExport({
						type:type,
						pageNumber:$(this).parents('.bootstrap-table').find('.fixed-table-pagination .pull-right.pagination .page-number.active').text()||1,
						pageSize:$(this).parents('.bootstrap-table').find('.fixed-table-pagination .dropdown-toggle .page-size').text()||1
					});
                })
