 ...
 *
 */
public class ReqActivity extends AbsReq {

	public ReqActivity(InterfaceMessage msg) throws AbsHosException {
		super(msg);
		...
		this.expiretime = XMLUtil.getString(ser, "expireTime", false);
		this.starttime = XMLUtil.getString(ser, "startTime", false);
		this.endtime = XMLUtil.getString(ser, "endTime", false);
		this.totalnumber = XMLUtil.getInt(ser, "totalNumber", false);
		...
		this.intro = XMLUtil.getString(ser, "intro", false);
