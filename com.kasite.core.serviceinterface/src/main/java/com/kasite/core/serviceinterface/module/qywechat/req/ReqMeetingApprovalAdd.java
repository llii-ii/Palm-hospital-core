 ...
 *
 */
public class ReqMeetingApprovalAdd extends AbsReq {
	...
	public ReqMeetingApprovalAdd(InterfaceMessage msg) throws AbsHosException {
		super(msg);
		Element ser = root.element(KstHosConstant.DATA);
		this.id = XMLUtil.getLong(ser, "id", false);
		this.approvalid = XMLUtil.getString(ser, "approvalId", false);
		...
		this.meetingid = XMLUtil.getString(ser, "meetingId", true);
		this.meetingtitle = XMLUtil.getString(ser, "meetingTitle", false);
		this.reason = XMLUtil.getString(ser, "reason", true);
