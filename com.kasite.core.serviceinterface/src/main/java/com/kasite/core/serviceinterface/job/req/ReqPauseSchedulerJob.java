...
public class ReqPauseSchedulerJob extends AbsReq{
	private Long jobId;
	...
	public ReqPauseSchedulerJob(InterfaceMessage msg) throws AbsHosException {
		super(msg);
	...
	public ReqPauseSchedulerJob(InterfaceMessage msg, Long jobId, List<Long> jobIds) throws AbsHosException {
		super(msg);
		this.jobId = jobId;
		this.jobIds = jobIds;
	}
