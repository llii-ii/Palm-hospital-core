 ...
 * 2017-7-24 下午2:29:38
 */
public class ReqQueryBatUser extends AbsReq {
	...
	public ReqQueryBatUser(InterfaceMessage msg) throws AbsHosException {
		super(msg);
	...
	public ReqQueryBatUser(InterfaceMessage msg, String openId, String nickName, String accountId, Integer sex,
			String city, String country, String province, String language, String headImgUrl, Integer subscribe,
			Integer subscribeTime, String unionId, String remark, Integer groupId, Integer state)
