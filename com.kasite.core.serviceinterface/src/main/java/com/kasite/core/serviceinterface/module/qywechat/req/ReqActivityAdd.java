 ...
 *
 */
public class ReqActivityAdd extends AbsReq {

	public ReqActivityAdd(InterfaceMessage msg) throws AbsHosException {
		super(msg);
		Element ser = root.element(KstHosConstant.DATA);
		this.id = XMLUtil.getLong(ser, "id", false);
		this.activityid = XMLUtil.getString(ser, "activityId", false);
		this.title = XMLUtil.getString(ser, "title", true);
		this.expiretime = XMLUtil.getString(ser, "expireTime", true);
		this.starttime = XMLUtil.getString(ser, "startTime", true);
		this.endtime = XMLUtil.getString(ser, "endTime", true);
		this.totalnumber = XMLUtil.getInt(ser, "totalNumber", true);
		this.place = XMLUtil.getString(ser, "place", true);
		this.status = XMLUtil.getInt(ser, "status", true);
		this.operatorid = XMLUtil.getString(ser, "operatorId", false);
		this.operatorname = XMLUtil.getString(ser, "operatorName", false);
		this.intro = XMLUtil.getString(ser, "intro", true);
		...
		this.attachmentUrl = XMLUtil.getString(ser, "attachmentUrl", false);
		this.attachmentName = XMLUtil.getString(ser, "attachmentName", false);
		this.imgUrl = XMLUtil.getString(ser, "imgUrl", false);
		this.imgName = XMLUtil.getString(ser, "imgName", false);
	}
