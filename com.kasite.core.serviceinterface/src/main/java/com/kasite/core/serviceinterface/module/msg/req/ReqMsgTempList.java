 ...
 */
public class ReqMsgTempList extends AbsReq{
	 ...
	 */
	public ReqMsgTempList(InterfaceMessage msg,String wxKey) throws AbsHosException {
		super(msg);
		this.wxKey = wxKey;
	...
	public ReqMsgTempList(InterfaceMessage msg) throws AbsHosException {
		super(msg);
		Element dataEl = root.element(KstHosConstant.DATA);
		this.useChannel = XMLUtil.getString(dataEl, "useChannel", false);
		this.modeType = XMLUtil.getString(dataEl, "modeType", false);
