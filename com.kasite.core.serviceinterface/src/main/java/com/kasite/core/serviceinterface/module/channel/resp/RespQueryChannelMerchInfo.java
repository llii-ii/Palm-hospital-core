 ...
 *
 */
public class RespQueryChannelMerchInfo extends AbsResp {
	...
	private List<RespQueryChannelApi> apiList;
	
	private JSONObject ipWhiteJson;
	...
	public List<RespQueryChannelApi> getApiList() {
		return apiList;
	}

	public void setApiList(List<RespQueryChannelApi> apiList) {
		this.apiList = apiList;
	}

	public JSONObject getIpWhiteJson() {
		return ipWhiteJson;
	}

	public void setIpWhiteJson(JSONObject ipWhiteJson) {
		this.ipWhiteJson = ipWhiteJson;
	}
