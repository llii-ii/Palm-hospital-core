...
public class ReqDelSchedulerJob extends AbsReq{
	...
	public ReqDelSchedulerJob(InterfaceMessage msg) throws AbsHosException {
		super(msg);
	...
	public ReqDelSchedulerJob(InterfaceMessage msg, Long jobId, List<Long> jobIds) throws AbsHosException {
		super(msg);
		this.jobId = jobId;
		this.jobIds = jobIds;
	}
