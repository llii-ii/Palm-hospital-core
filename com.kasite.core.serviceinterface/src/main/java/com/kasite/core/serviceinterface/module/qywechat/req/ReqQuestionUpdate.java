 ...
 *
 */
public class ReqQuestionUpdate extends AbsReq {
	public ReqQuestionUpdate(InterfaceMessage msg) throws AbsHosException {
		super(msg);
		Element dataEl = root.element(KstHosConstant.DATA);
		this.id = XMLUtil.getLong(dataEl, "id", true);
		this.themeid = XMLUtil.getString(dataEl, "themeId", false);
		this.questname = XMLUtil.getString(dataEl, "questName", false);
		this.questtype = XMLUtil.getInt(dataEl, "questType", false, null);
		this.ismust = XMLUtil.getInt(dataEl, "isMust", false, null);
		this.operatorid = XMLUtil.getString(dataEl, "operatorId", false);
		this.operatorname = XMLUtil.getString(dataEl, "operatorName", false, null);
