...
public class AlipayMsgBuildUtil {
     ...
     * @return
     */
    public static String buildBaseAckMsg(String zfbKey,String fromUserId) {
        StringBuilder sb = new StringBuilder();
        sb.append("<XML>");
        sb.append("<ToUserId><![CDATA[" + fromUserId + "]]></ToUserId>");
        sb.append("<AppId><![CDATA[" + KasiteConfig.getZfbConfig(ZFBConfigEnum.zfb_appId, zfbKey) + "]]></AppId>");
